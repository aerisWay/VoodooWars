...
void OutlineObject_float(float2 UV, float OutlineThickness, float DepthSensibility, float NormalSensibility, out float Out)
{
	...
	float depthThreshold = (1/DepthSensibility) * depthSamples[0];
	...
	edgeNormal = edgeNormal > (1/NormalSensibility) ? 1 : 0;
